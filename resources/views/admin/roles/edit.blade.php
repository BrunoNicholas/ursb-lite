                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-8" style="max-height: 300px; overflow-y: auto;">
                                                ...
                                                @foreach($permissions as $permission)
                                                    <input type="checkbox"{{ in_array($permission->id, $permission_role)?"checked":"" }} name="permission[]" value="{{ $permission->id }}" id="permckbx{{ $i }}"> <label for="permckbx{{ $i }}">{{ $permission->display_name }} </label> <br><!-- {{ ++$i }} -->
                                                @endforeach
                                            </div>
                                        </div>
                                    </div>
